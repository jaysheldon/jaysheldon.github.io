...
async function app() {
  ...
  while (true) {
	  ...
	  if (stand_p10_avg > STAND_THRESH & stand_p10_avg > AVG_PROB_THRESH*stand_avg & stand_p10_min > stand_avg*MIN_PROB_THRESH) {
		  classified = true;
		  frameclass = "stand";
	  }
	  ...
	  if (frameclass=="squat") {
		  if (last_state == "stand") {
			  ...
			  if (in_squat == LOOKBACK)  {
				...
				squat_count += 1;
				last_state = "squat";
				document.getElementById("message").innerHTML = "<h2>SQUAT #" + squat_count + "</h2>" + msgs;
			}
	  }
	  ...
	  if (frameclass=="lunge") {
		if (last_state == "stand") {
			  ...
			  if (in_lunge == LOOKBACK)  {
				...
				lunge_count += 1
				last_state = "lunge";
				document.getElementById("message").innerHTML = "<h2>LUNGE #" + lunge_count + "</h2>" + msgs;
			  }
	  ...
	  if (frameclass=="stand") {
		  ...
		  */
		  ...
		  if (in_stand == LOOKBACK)  {
			if (last_state != "stand") {
				document.getElementById("message").innerHTML = "<h2>STANDING</h2>" + msgs;
			} 
			  last_state = "stand";
		  }
	  }	  
